...
exports.setOrChangeRole = exports.deleteUser = exports.editUser = exports.reset = exports.forgot = exports.changePassword = exports.login = exports.signup = exports.getUsers = exports.currentUser = void 0;
...
const setOrChangeRole = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (value.role) {
            ...
            if (!isRole)
                return response_service_1.ResponseService.json(res, 400, 'Invalid role.');
        }
